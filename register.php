<?php
session_start(); // Mulai sesi untuk menangani pesan flash

// Konfigurasi koneksi database
require_once 'config.php'; // Pastikan file config.php ada dan berisi DB_HOST, DB_USER, DB_PASS, DB_NAME
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->close();
    header('Location: register.php'); // Redirect kembali ke halaman register untuk menampilkan pesan
    exit();
}

// Ambil pesan dari sesi jika ada (dari redirect sebelumnya)
if (isset($_SESSION['success_message'])) {
    $register_message = "<div class='message success-message'><i class='fas fa-check-circle'></i> " . htmlspecialchars($_SESSION['success_message']) . "</div>";
    unset($_SESSION['success_message']);
} elseif (isset($_SESSION['error_message'])) {
    $register_message = "<div class='message error-message'><i class='fas fa-times-circle'></i> " . htmlspecialchars($_SESSION['error_message']) . "</div>";
...
<head>
    ...
    <style>
        ...
        .register-container::before { /* Dekorasi sudut atas-kiri */
            content: '';
            position: absolute;
            top: -30px;
            left: -30px;
        ...
        .register-container::after { /* Dekorasi sudut bawah-kanan */
            content: '';
            position: absolute;
            bottom: -30px;
            right: -30px;
        ...
        /* Tombol Registrasi (menggunakan gaya btn-primary) */
        .register-button {
            width: 100%;
            padding: 1rem;
        ...
        .register-button::after { /* Efek ripple pada tombol */
            content: '';
            position: absolute;
            width: 0;
            height: 0;
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Efek Ripple pada Tombol Registrasi
